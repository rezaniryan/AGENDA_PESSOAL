...
public class ContatoModel {
     ...
     */
    public ContatoModel() {
        emf = Persistence.createEntityManagerFactory("AgendaPU"); // Corrigido o nome do persistence unit.
    ...
    /**
     * Atualiza um novo contato existente ao banco de dados.
     *
    ...
    public List<Contato> listarContatos() {
        try {
            return em.createQuery("SELECT c FROM Contato c", Contato.class).getResultList(); // Corrigida a consulta JPQL.
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
